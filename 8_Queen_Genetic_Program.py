    ...
    def Generate_childs(self):
        ...
        for loop in range(self.MaxGenerations):
            ...
            if(self.match(child)):
                ...
                print("And Exactly matched with Random solution picked from 8 Queens Problem")
                print("")
...
def main():
    ...
    print("Welcome!!!")
    print(" ")
    print("**8 QUEENS PROBLEM** Generating all possible solutions. Please wait..." )
    print(" ")
    ...
    print("")
    print("Now generating solution using genetic programming approach")
    print("And then verify with this 8 queen puzzle random Solution")
    print("Initializing.....")    
    print("")
    time.sleep(3)
